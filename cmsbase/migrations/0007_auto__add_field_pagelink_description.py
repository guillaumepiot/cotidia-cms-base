...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageLink.description'
        db.add_column(u'cmsbase_pagelink', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=250, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PageLink.description'
        db.delete_column(u'cmsbase_pagelink', 'description')
