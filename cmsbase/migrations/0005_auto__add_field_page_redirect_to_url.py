...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.redirect_to_url'
        db.add_column(u'cmsbase_page', 'redirect_to_url',
                      self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.redirect_to_url'
        db.delete_column(u'cmsbase_page', 'redirect_to_url')
