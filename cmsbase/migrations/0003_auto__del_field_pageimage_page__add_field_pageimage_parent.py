...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PageImage.page'
        db.delete_column(u'cmsbase_pageimage', 'page_id')

        # Adding field 'PageImage.parent'
        db.add_column(u'cmsbase_pageimage', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cmsbase.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'PageImage.page'
        db.add_column(u'cmsbase_pageimage', 'page',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['cmsbase.Page']),
                      keep_default=False)

        # Deleting field 'PageImage.parent'
        db.delete_column(u'cmsbase_pageimage', 'parent_id')
