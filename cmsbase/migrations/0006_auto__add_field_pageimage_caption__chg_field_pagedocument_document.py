...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageImage.caption'
        db.add_column(u'cmsbase_pageimage', 'caption',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


        # Changing field 'PageDocument.document'
        db.alter_column(u'cmsbase_pagedocument', 'document', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):
        # Deleting field 'PageImage.caption'
        db.delete_column(u'cmsbase_pageimage', 'caption')


        # Changing field 'PageDocument.document'
        db.alter_column(u'cmsbase_pagedocument', 'document', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
