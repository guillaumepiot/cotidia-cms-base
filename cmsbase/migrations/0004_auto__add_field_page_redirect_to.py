...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cms_page', 'redirect_to',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='redirect_to_page', null=True, to=orm['cms.Page']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.redirect_to'
        db.delete_column('cms_page', 'redirect_to_id')
    ...
    models = {
        'cms.page': {
            ...
            'date_updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 1, 14, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
