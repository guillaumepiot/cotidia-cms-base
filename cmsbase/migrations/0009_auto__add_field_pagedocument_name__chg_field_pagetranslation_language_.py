...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PageDocument.name'
        db.add_column(u'cmsbase_pagedocument', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True),
                      keep_default=False)


        # Changing field 'PageTranslation.language_code'
        db.alter_column(u'cmsbase_pagetranslation', 'language_code', self.gf('django.db.models.fields.CharField')(max_length=7))

    def backwards(self, orm):
        # Deleting field 'PageDocument.name'
        db.delete_column(u'cmsbase_pagedocument', 'name')


        # Changing field 'PageTranslation.language_code'
        db.alter_column(u'cmsbase_pagetranslation', 'language_code', self.gf('django.db.models.fields.CharField')(max_length=5))
