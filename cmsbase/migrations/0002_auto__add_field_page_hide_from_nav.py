...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.hide_from_nav'
        db.add_column(u'cmsbase_page', 'hide_from_nav',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.hide_from_nav'
        db.delete_column(u'cmsbase_page', 'hide_from_nav')
    ...
    models = {
        ...
        u'cmsbase.pageimage': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['cmsbase.Page']"})
        },
